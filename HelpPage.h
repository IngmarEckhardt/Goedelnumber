...
std::string helpText
        = "Das vorliegende Programm entstand als Abschlussarbeit der Vorlesung Grundlagen der Programmierung an der HTWK - Leipzig.\n\n"
          "Das Programm dient der Berechnung der sogenannten Gödelnummer nach der Eingabe einer Aussageformeln. Die Gödelnummer beruht auf\n"
          ...
          "Beim Programmaufruf kann mit dem Aufrufargument 'np' dieses erneute Anlegen einer Datei auch bei vorhandener Datei erzwungen werden,\n"
          "des weiteren wird mit dem Aufrufargument 'debug' das Programm umfangreichen Einblick in seinen Ablauf geben um den korrekten\n"
          "Programmablauf zu überprüfen.\n\n"
